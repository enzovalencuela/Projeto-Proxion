  ...
  try {
    ...
    if (documentos.length > 0) {
      ...
      const estrutura = {
        ...
        nomeCampoSerie: doc["Numero de serie"]
          ? "Numero de serie"
          : doc.Numero_de_serie
          ? "Numero_de_serie"
          : "Desconhecido",
        tipoSerie: doc["Numero de serie"]
          ? typeof doc["Numero de serie"]
          : "N/A",
      ...
      estrutura.camposVistoria = {
        ...
        outrosCampos: Object.keys(doc).filter((k) =>
          k.toLowerCase().includes("vistori")
        ),
      };
